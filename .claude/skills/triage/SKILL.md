---
name: triage
description: Move issues on the project issue tracker through a triage state machine. Use when user wants to triage issues, see what needs attention, or move an issue to a state.
---
...
See `docs/agents/triage-labels.md` for label mappings and `docs/agents/issue-tracker.md` for tracker conventions.
...
5. **Apply the outcome:**
   ...
   - `wontfix` (enhancement) — explain why, then close.
